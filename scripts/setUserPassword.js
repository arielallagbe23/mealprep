// Usage: node scripts/setUserPassword.js <email> <newPassword>
...
async function main() {
  ...
  if (password.length < 6) {
    console.error("Mot de passe trop court (6 caractères min)");
    process.exit(1);
  }
  ...
  console.log(`✅ Mot de passe mis à jour pour ${email} (${doc.id})`);
}
